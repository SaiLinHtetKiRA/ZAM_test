...
const Categogories: StylesConfig = {
    ...
    control: (styles,{hasValue,isMulti}) => {
      ...
      boxShadow: 0,
      ...hasValue ? isMulti && { paddingLeft:10,
        paddingRight:30,
        paddingTop:5,
    ...
    input: (styles) => ({ ...styles, color: `rgba(${color},0.8)`,fontSize: 15,fontWeight:"bold",textTransform:"capitalize"}),
    ...
    menu: (styles,{isMulti,hasValue}) => ({ ...styles, marginTop: 1,backgroundColor:"rgba(0, 0, 0,0.8)", ...hasValue ? isMulti && {paddingLeft:10,
      paddingRight:20,
      paddingTop:5,
      paddingBottom:5} :{paddingLeft:10,
        paddingRight:20,
    ...
    menuList: (styles) => ({ ...styles, padding: 0,display:"flex",flexWrap:"wrap",gap:5 , alignItems:"center",justifyContent:"center",width:"100%",}),
    container: (styles) => ({ ...styles, padding: 0 }),
    multiValue:(styles)=>({...styles,backgroundColor:"transparent",borderWidth:1.5,borderColor: `rgba(${color},0.6)`,borderRadius: 2, }),
    multiValueLabel:(styles)=>({...styles,color:`rgba(${color},0.8)`,letterSpacing:0.8,fontWeight:"bold"}),
